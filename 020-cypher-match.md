...
Svuotiamo tutto il db. Nella versione community non è possibile cambiare db da console.

    MATCH (n) DETACH DELETE n

Caricare il DB dei film
-----------------------

Label e property per i nodi:
* Person
    * name
    * born (yr)
* Movie
...
Scegliere le proprietà da restituire
...
I film in cui Tom Hanks ha avuto un ruolo
    ...
    MATCH({name: "Tom Hanks"})--(m:Movie) RETURN m.title
...
Qui ci sono recensori, produttori, ma noi siamo solo interessati agli
attori e registi

    MATCH (people:Person)-[r:ACTED_IN|DIRECTED]-(:Movie {title: "Cloud Atlas"}) RETURN people.name, type(r), r   

Le recensioni di un film.
